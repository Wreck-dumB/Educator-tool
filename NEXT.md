...
- [ ] **#3 Family data access (Privacy Act APP 12)** — give families a complete read-only view/export of everything on file about their child. Parent portal exists as the base. *Design: portal "everything on file" view + downloadable export.*
