...
import { sendMessageFromParent } from "../actions";
  ...
  return (
    <div>
      <div className="flex items-center gap-3">
        <Link href="/parent/messages" className="text-sm text-coral-dark hover:underline">
          ← Messages
        </Link>
      </div>
      ...
      <form action={sendMessageFromParent} className={`mt-4 p-4 ${cardClass} space-y-3`}>
