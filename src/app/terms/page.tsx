  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12 text-ink">
      ...
      <p className="mt-6 text-sm text-ink/70">
        These terms govern your use of DR. SparkPlay. By creating an account or clicking &ldquo;I accept&rdquo;,
        you agree to these terms. Please read them carefully.
      </p>

      <Section title="1. What DR. SparkPlay is">
        <p>
          DR. SparkPlay is a productivity tool for early childhood educators. It helps you draft
          EYLF-linked learning programs, log observations, manage attendance, and maintain
          administrative records.
        </p>
        <p className="mt-2 font-semibold text-amber-800">
          DR. SparkPlay is a tool, not a compliance advisor. It does not provide legal, regulatory,
      ...
      <Section title="3. Data you enter">
        <p>
          You retain ownership of all data you enter into DR. SparkPlay, including child records,
        ...
        <p className="mt-2">
          ...
          or families has been collected lawfully and with appropriate consent. DR. SparkPlay stores
      ...
      <Section title="4. AI-generated content">
        <p>
          DR. SparkPlay uses AI (Anthropic&apos;s Claude) to generate activity suggestions, learning
      ...
      <Section title="5. Regulatory accuracy">
        <p>
          DR. SparkPlay displays educator-to-child ratios based on the{" "}
        ...
        <p className="mt-2 font-semibold text-amber-800">
          ...
          authority before relying on them. DR. SparkPlay accepts no liability for ratio calculations
        ...
        <p className="mt-2">
          ...
          DR. SparkPlay are provided for convenience only and may not reflect the most current law.
      ...
      <Section title="6. Mandatory reporting">
        <p>
          DR. SparkPlay includes a mandatory reporting reference section on the incident reports page.
        ...
        <p className="mt-2 font-semibold text-amber-800">
          ...
          a supervisor, or another staff member. DR. SparkPlay does not determine whether any specific
      ...
      <Section title="7. Permission slip e-signatures">
        <p>
          Parent signatures collected through DR. SparkPlay&apos;s permission slip feature are electronic
      ...
      <Section title="8. Child records and confidentiality">
        ...
        <p className="mt-2">
          DR. SparkPlay&apos;s role-based access controls are designed to assist with this obligation, but
          you remain responsible for managing who has access to your DR. SparkPlay account and for
          ensuring your service&apos;s data handling practices meet regulatory requirements.
        </p>
      </Section>

      <Section title="9. Acceptable use">
        <p>You must not use DR. SparkPlay to:</p>
        <ul>
      ...
      <Section title="10. Availability and data loss">
        <p>
          We aim to keep DR. SparkPlay available at all times, but we do not guarantee uninterrupted
          ...
          rely on DR. SparkPlay as your sole record-keeping system.
        </p>
      </Section>

      <Section title="11. Limitation of liability">
        <p>
          To the maximum extent permitted by Australian law, DR. SparkPlay&apos;s liability for any loss
          or damage arising from your use of the service is limited to the amount you paid for
          DR. SparkPlay in the 12 months preceding the claim, or $100 AUD, whichever is greater.
        </p>
        <p className="mt-2">
