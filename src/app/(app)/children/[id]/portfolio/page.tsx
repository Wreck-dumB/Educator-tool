...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  return { title: child ? `${child.first_name} — Portfolio · DR. SparkPlay` : "Portfolio · DR. SparkPlay" };
}
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <div className="print:text-black">
        ...
        <div className="mt-10 border-t border-coral-light pt-4 text-xs text-ink/40 print:border-black print:text-black">
          <p>
            Generated by DR. SparkPlay · {new Date().toLocaleDateString("en-AU")} · Based on the Early
