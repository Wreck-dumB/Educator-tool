...
export type ChildEnrolmentSubmission = Database["public"]["Tables"]["child_enrolment_submissions"]["Row"];
export type ChildEnrolmentDocument = Database["public"]["Tables"]["child_enrolment_documents"]["Row"];
export type ChildContactSubmission = Database["public"]["Tables"]["child_contact_submissions"]["Row"];
