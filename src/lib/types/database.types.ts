...
export type GenerationMode = "materials" | "time" | "outcome" | "interest" | "surprise_me" | "shared_library";
    ...
    Tables: {
      ...
      shared_library_activities: {
        Row: {
          ...
          odd_one_out_different: string | null;
          cut_and_sort_groups: { label: string; items: string[] }[];
          status: "pending_ai_review" | "ai_flagged" | "pending_admin_review" | "approved" | "rejected";
        ...
        Update: Partial<Database["public"]["Tables"]["shared_library_activities"]["Insert"]>;
        Relationships: [];
      };
      activity_eylf_links: {
        Row: {
