...
export interface RawActivitySuggestion {
  ...
  eylf_codes: string[];
  suggested_template?: "name_trace" | "name_colouring" | "drawing_frame" | "writing_lines" | null;
}
